//
//  MiddleContainerExtensions.swift
//  COVIDStatisticsGov
//
...
extension MiddleContainerDelegate {
    
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        return CGSize(width: collectionView.bounds.width - 30 , height: UIScreen.main.bounds.height / 8)
    }
